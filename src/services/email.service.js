...
const sendtransactionfailureEmail = async (userEmail, name, transactionDetails) => {
    ...
    const html = `<p>Hello ${name},</p><p>We regret to inform you that a transaction on your account has failed:</p><p>${transactionDetails}</p><p>Please contact support for assistance.</p><p>Best regards,<br>The Backend Ledger Team</p>`;
